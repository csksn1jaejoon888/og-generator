...
export async function GET(request) {
  ...
  // ✅ Font fetch di DALAM handler dengan fallback
  let fontData = null;
  try {
    const fontRes = await fetch('https://og.trend4genz.fun/RobotoCondensed.ttf');
    if (fontRes.ok) fontData = await fontRes.arrayBuffer();
  } catch(e) {
    fontData = null; // fallback ke sans-serif
  }
  ...
  const response = new ImageResponse(
    (
      <div style={{
        ...
        <img
          src="https://og.trend4genz.fun/bg.png?v=4"
          width={1200}
          height={630}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              ...
              letterSpacing: 2, marginRight: 2, display: 'flex',
            }}>TAG :</span>
            {tags.map((tag, i) => (
              <div key={i} style={{
                border: '1px solid #98FB98', borderRadius: 10,
                padding: '2px 12px', fontSize: 11,
                color: '#98FB98', display: 'flex',
              }}>
          ...
          <div style={{
            ...
            {shortSummary}
            {isCut && (
              <span style={{ color: '#cccccc', marginLeft: 0, display: 'flex', alignItems: 'center' }}>
                ...
                <span style={{ color: '#98FB98', fontWeight: 800, fontSize: 16, marginLeft: 4, display: 'flex' }}>›</span>
              </span>
            )}
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 16 }}>
            <span style={{
              fontSize: 13, color: '#98FB98', fontWeight: 700,
  ...
  // ✅ Ganti ke public cache — X butuh ini
